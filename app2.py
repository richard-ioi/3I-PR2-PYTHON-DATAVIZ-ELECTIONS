...
d021 = pd.read_csv('data/elections_2002_T1.csv' ,error_bad_lines=False, sep=';', low_memory=False)
...
d071 = pd.read_csv('data/elections_2007_T1.csv' ,error_bad_lines=False, sep=';', low_memory=False)
d072 = pd.read_csv('data/elections_2007_T2.csv' ,error_bad_lines=False, sep=';', low_memory=False)
...
d122 = pd.read_csv('data/resultats_communes_T2.csv' ,error_bad_lines=False, sep=';', low_memory=False)
...
df = pd.DataFrame(year_data, columns = ['year', 'associated_df']) 
